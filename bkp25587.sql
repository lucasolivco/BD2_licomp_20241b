...
--
-- Table structure for table `intituicoes`
--

DROP TABLE IF EXISTS `intituicoes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `intituicoes`
--

LOCK TABLES `intituicoes` WRITE;
/*!40000 ALTER TABLE `intituicoes` DISABLE KEYS */;
/*!40000 ALTER TABLE `intituicoes` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-03-28 20:33:04
